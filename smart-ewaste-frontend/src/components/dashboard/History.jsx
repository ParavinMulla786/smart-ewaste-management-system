 ...
 * Shows all pickup requests made by the current user with filters
 */
...
const History = () => {
  ...
  const [timeFilter, setTimeFilter] = useState('all'); // all, today, week, month, 90days
  const [statusFilter, setStatusFilter] = useState('all'); // all, PENDING, ON_HOLD, IN_PROGRESS, RESOLVED, REJECTED
  ...
  useEffect(() => {
    applyFilters();
  }, [requests, timeFilter, statusFilter, sortOrder]);
    ...
    <div className="history-page">
      ...
      <div className="history-container">
        <div className="history-header">
          ...
          <p>View all your e-waste pickup requests</p>
        </div>
